...
class CompanyController extends Controller
{
    ...
    public function update(Request $request, Company $company)
    {
        ...
        $validated = $request->validate([
            ...
            'tp_type' => 'sometimes|nullable|string|max:255',
            'tp_name' => 'sometimes|nullable|string|max:255',
            'tp_TIN' => 'sometimes|nullable|string|unique:companies,tp_TIN,'.$company->id.'|max:255',
            'tp_trade_number' => 'sometimes|nullable|string|max:255',
            'tp_postal_number' => 'sometimes|nullable|string|max:255',
            'tp_phone_number' => 'sometimes|nullable|string|max:255',
            'tp_address_province' => 'sometimes|nullable|string|max:255',
            'tp_address_commune' => 'sometimes|nullable|string|max:255',
            'tp_address_quartier' => 'sometimes|nullable|string|max:255',
            'tp_address_avenue' => 'sometimes|nullable|string|max:255',
            'tp_address_rue' => 'sometimes|nullable|string|max:255',
            'tp_address_number' => 'sometimes|nullable|string|max:255',
            'tp_fiscal_center' => 'sometimes|nullable|string|max:255',
            'tp_activity_sector' => 'sometimes|nullable|string|max:255',
            'tp_legal_form' => 'sometimes|nullable|string|max:255',
            'vat_taxpayer' => 'sometimes|nullable|string|max:255',
            'ct_taxpayer' => 'sometimes|nullable|string|max:255',
            'tl_taxpayer' => 'sometimes|nullable|string|max:255',
            'system_or_device_id' => 'sometimes|nullable|string|max:255',
            'default_currency' => 'sometimes|nullable|string|max:255',

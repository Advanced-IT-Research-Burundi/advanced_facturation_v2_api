...
class HotelReceptionBookingController extends Controller
{
    ...
    public function generateInvoice(Request $request, HotelReceptionBooking $hotelReceptionBooking): JsonResponse
    {
        try {
            $invoice = $this->hotelInvoiceService->generateReceptionInvoice($hotelReceptionBooking);
